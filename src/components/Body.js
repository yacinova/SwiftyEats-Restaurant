  ...
  return listOfRestaurants && listOfRestaurants.length === 0 ? (
    ...
    <div className="p-5 bg-gray-100 mt-8">
      ...
      <div className="flex justify-center mt-10 flex-wrap gap-2.5">
        <button
          className="flex items-center bg-white border border-gray-300 px-4 py-2 rounded-full cursor-pointer transition duration-300 ease-in-out hover:bg-orange-100 hover:text-white"
