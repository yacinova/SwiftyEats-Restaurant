...
const User = () => {
  ...
  const fetchUserData = async () => {
    try {
      const response = await fetch(
        "https://api.github.com/users/yacinova"
      );
  ...
  return (
    <div className="max-w-lg mx-auto my-auto bg-white shadow-xl rounded-lg overflow-hidden transform transition duration-500 hover:scale-105  ">
